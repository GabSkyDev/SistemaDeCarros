...
public class ServicoResponseDTO {
    ...
    public ServicoResponseDTO(String descricao, LocalDate dataServico, BigDecimal valorPago, Long mecanicaId, String mecanicaNome, Long carroId, String placaCarro, String modeloCarro) {
